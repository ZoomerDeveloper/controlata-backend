...
app.get('/api/dashboard', (req, res) => {
  res.json({
    ...
    recentOrders: [
      { id: '1', customerName: 'Иван Петров', status: 'COMPLETED', total: 120 },
      { id: '2', customerName: 'Мария Сидорова', status: 'IN_PROGRESS', total: 85 },
      { id: '3', customerName: 'Алексей Козлов', status: 'PENDING', total: 200 }
    ],
    topCustomers: [

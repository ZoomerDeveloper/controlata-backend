...
const corsOptions = {
  origin: function (origin, callback) {
    ...
    const allowedOrigins = [
      ...
      'https://api.art24.me',
      'http://admin-art24.online.swtest.ru',
      'https://admin-art24.online.swtest.ru'
    ].filter(Boolean);
    
    // Разрешаем все поддомены .swtest.ru для разработки
    if (origin && origin.includes('.swtest.ru')) {

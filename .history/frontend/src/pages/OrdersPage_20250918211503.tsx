  ...
  const handleSubmit = async (values: any) => {
    try {
      ...
      const processedPictures = await Promise.all((values.pictures || []).map(async (picture: any, index: number) => {
        ...
        console.log('🔍 Обрабатываем картину:', {
          index,
          isCustomPhoto,
          picture,
                                ...
                                <Col span={6}>
                                  ...
                                  >
                                    <Select placeholder="Выберите размер">
                                      <Option value="cmfojkjym00015ql328ck55an">A4 (21x29.7 см)</Option>
                                      <Option value="cmfojkloh00025ql3j0nuqx6z">A3 (29.7x42 см)</Option>
                                      <Option value="cmfojkmnn00035ql37s8kwftp">30x40 (30x40 см)</Option>
                                      <Option value="cmfojkp5300045ql3nn6c6pxc">40x50 (40x50 см)</Option>
                                      <Option value="cmfokf0x80000nfomucp5l5c3">50x70 (50x70 см)</Option>
                                    </Select>
                                  </Form.Item>
                                </Col>
                              )}
